...
def rank_mappings_node(state: MappingState) -> MappingState:
    # This node is used to rank the UMLS terms, input is the list of UMLS terms, output is a list of ranked UMLS terms with confidence score
...
def validate_mapping_node(state: MappingState) -> MappingState:
    # This node is used to validate the mapping, input is the list of UMLS terms, output is a list of ranked UMLS terms with best match and confidence score
